        ...
        <div class="row">
                    ...
                    <div class="col-sm-8">
                        ...
                        <div class="qty d-flex pt-2">
                            <div class="d-flex w-25">
                                ...
                                <input type="text" data-id="<?php echo $item['item_id'] ?? '0'; ?>" class="qty-input border px-4 w-100 bg-light" disabled value="1" placeholder="1">
            ...
            <div class="col-sm-3">
                <div class="sub-total border text-center">
                    <h6 class="font-size-12 text-success py-3"><i class="fas fa-check"> Your delivery is eligible for Free Delivery</i></h6>
