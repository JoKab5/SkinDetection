...
<div class="header">
    ...
    <div class="container">
        ...
        <div class="navbar">
            <nav class="navbar navbar-light bg-light">
                ...
                <ul id="MenuItems">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="#" style="background-color: #e76fab; color: white; border-radius: 5px"><?php
                            session_start();
        ...
        <div class="row">
            <div class="col-2">
                <h1>Give Your Life <br> A New Dress Style </h1>

            </div>
            <div class="col-2">
                <img src="images/adob1.png">
            </div>
        </div>
