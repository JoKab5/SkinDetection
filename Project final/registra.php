...
<div class="account-page">
    <div class="container">
        <div class="row"><img src="images/Slide3.PNG" width="200px"><h3 style="margin-left: 150px"><u>Make Your life Easy!.... Shop With Us....</u></h3></div>
        <div class="row">
            <div class="col-2">
            ...
            <div class="col-2">
                <div class="form-container">
                    ...
                    <form id="LoginForm" action="backprocess.php" method="POST">
                        <?php
                        if(@$_GET['Empty']==true)
                        {
                            ?>
                    ...
                    <form id="RegForm" action="insert.php" method="POST">
                        ...
                        <input name="mobil" type="number" placeholder="Mobile No" required>
